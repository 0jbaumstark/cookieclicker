...
class MyScreenManager(ScreenManager, Widget):
    ...
    def load_game(self, data):
        ...
        pass    def start_new_game(self):
        self.manager.current = 'character'
        pass    passclass CreateNewCharacterScreen(Screen):
    instructions = StringProperty(str('''
    ...
    fail_instructions = StringProperty(str('''
        ...
        '''))
    data_stats: PlayerStatistics = ObjectProperty(PlayerStatistics)    def create_character(self, username):
        if username != '':
